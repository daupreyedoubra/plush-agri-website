            ...
            >
              ...
              <div>
                <a
                  ...
                  aria-label="Chat with Plush Agri Solutions on WhatsApp"
                >
                  <svg
                ...
                <p className="mt-2 text-xs text-gray-400">
                  Fastest response, typically within the hour.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-xs font-semibold tracking-wide uppercase text-primary mb-1">Phone</p>
                  <a href="tel:+2348033670509" className="text-base text-gray-700 hover:text-primary transition-colors">
                    +234 803 367 0509
                  </a>
                </div>
                <div>
                  <p className="text-xs font-semibold tracking-wide uppercase text-primary mb-1">Email</p>
                  <a href="mailto:plushagrisolutions@gmail.com" className="text-base text-gray-700 hover:text-primary transition-colors break-all">
              ...
              <div>
                ...
                <div className="flex items-center gap-5">
                  <a
                    ...
                    aria-label="Plush Agri Solutions on Instagram"
                  >
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-primary transition-colors"
                    aria-label="Plush Agri Solutions on Facebook"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-primary transition-colors"
                    aria-label="Plush Agri Solutions on LinkedIn"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
